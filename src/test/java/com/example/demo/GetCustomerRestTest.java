...
public class GetCustomerRestTest {
    ...
    public void testProductDetail_Vx0_success() {
        ...
        HttpEntity<String> entity = new HttpEntity( "Mahsa", headers);
        String url1 = "http://localhost:8889/getCustomer_Vx0Test/";

        output = restTemplate.postForObject(url1, entity, Customer.class);
