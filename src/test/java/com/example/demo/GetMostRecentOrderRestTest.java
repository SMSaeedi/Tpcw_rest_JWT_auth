...
public class GetMostRecentOrderRestTest {
    ...
    public void testProductDetail_Vx0_success() {
        ...
        String url1 = "http://localhost:8889/getMostRecentOrder_Vx0Test/";

        output = restTemplate.postForObject(url1, entity, Order.class);
