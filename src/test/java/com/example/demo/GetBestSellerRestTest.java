...
public class GetBestSellerRestTest {
    ...
    public void testProductDetail_Vx0_success() {
        ...
        HttpEntity<String> entity = new HttpEntity("Little Dorrit", headers);
        String url1 = "http://localhost:8889/getBestSellers_Vx0Test/";

        output = restTemplate.postForObject(url1, entity, List.class);
